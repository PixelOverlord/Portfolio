...
const Hero = () => {
  ...
  return (
    <div className="w-full">
      ...
      <h1 className="text-tubeLight-effect overflow-x-hidden text-[1.3rem] sm:text-[1.75rem] 
         md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px]">
        <Typewriter
          words={["App Developer", "Android Developer", "Flutter Developer"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={70}
      ...
      <div className="w-fit px-5 py-2 bg-slate-50 rounded-[20px] flex gap-5 items-center mt-32 sm:mt-20 md:mt-8 lg:mt-16">
        <Link to="https://www.youtube.com/@flutterDevil" target="_blank">
      ...
      <p className="mt-8 lg:text-xl md:text-[1.2rem] sm:text-[4rem] tracking-[2px]">{user.aboutMe}</p>
